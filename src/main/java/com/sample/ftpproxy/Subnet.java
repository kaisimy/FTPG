...
public class Subnet {
    ...
    /**
     * Creates a <code>com.sample.ftpproxy.Subnet</code> object from the specified
    ...
    /**
     * Creates a <code>com.sample.ftpproxy.Subnet</code> object from the string representation
